        ...
        const unsubscribe = onSnapshot(qMsgs, (snapshot) => {
            snapshot.docChanges().forEach((change) => {
                if (change.type === 'added') {
                    ...
                    setMessages(prev => {
                        // Prevent adding duplicates from the initial HTTP fetch 
                        const exists = prev.some(m => m.created_at === newMsg.created_at && m.content === newMsg.content);
                        if (exists) return prev;

                        if (newMsg.sender !== 'agent') {
                            try { new Audio('data:audio/mp3;base64,').play().catch(() => { }); } catch (e) { }
                        }
                        return [...prev, newMsg];
                    });
                }
